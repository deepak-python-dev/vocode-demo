...
RUN apt-get update \
        && apt-get install libportaudio2 libportaudiocpp0 portaudio19-dev libasound-dev libsndfile1-dev ffmpeg build-essential libssl-dev ca-certificates libasound2 wget python3-pip -y
